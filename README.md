...
| `garden.py` | Wiese (Geometry-Nodes-Streuung, im Viewport 10 %) und grüne Laubsträucher in den Erd-Beeten (eigene Collection „Garten“) – nach `build_house.py` erneut ausführen |
